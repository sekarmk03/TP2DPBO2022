    ...
    if ($id > 0) {
        ...
        <div class="card-body text-end">
            ...
            <div class="card-footer text-end">
                <a href="ubah.php?id=' . $row['pengurus_id'] . '"><button type="button" class="btn btn-success text-white">Ubah Data</button></a>
                <a href="detail.php?hapus=' . $row['pengurus_id'] . '"><button type="button" class="btn btn-danger">Hapus Data</button></a>
            </div>';
    }
}
...
// $detail->replace('DATA_TITLE', $title);
